  ...
  <div class="interview">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar">
          <div class="result one" :class="{'active' : this.prevention.prevention_4 == 'weekly'}" style="width:25%">
          ...
          <div class="result two"  :class="{'active' : this.prevention.prevention_4 == 'almostNever'}" style="width:8%">
        ...
        <div class="bar">
          ...
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'almostNever', 'two__bg' : this.prevention.prevention_4 !== 'almostNever'}" style="width:8%">8%</div>
