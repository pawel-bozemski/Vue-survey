  ...
  <div class="interview">
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar upper">
          <div class="result one" :class="{'active cont' : this.prevention.prevention_1 == 'yes1'}" style="width:48%">
            <p :class="{'visible' : this.prevention.prevention_1 == 'yes1', 'not__visible' : this.prevention.prevention_1 !== 'yes1'}">Twój wynik</p>
          </div>
          <div class="result two" :class="{'active cont' : this.prevention.prevention_1 == 'no1'}" style="width:52%">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar upper">
          ...
          <div class="result two" :class="{'active cont' : this.prevention.prevention_2 == 'no2'}" style="width:40%">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar upper">
          <div class="result one" :class="{'active cont' : this.prevention.prevention_3 == 'yes3'}" style="width:3630%">
            <p :class="{'visible' : this.prevention.prevention_3 == 'yes3', 'not__visible' : this.prevention.prevention_3 !== 'yes3'}">Twój wynik</p>
          </div>
          <div class="result two" :class="{'active cont' : this.prevention.prevention_3 == 'no3'}" style="width:64%">
            <p :class="{'visible' : this.prevention.prevention_3 == 'no3', 'not__visible' : this.prevention.prevention_3 !== 'no3'}">Twój wynik</p>
          </div>
        </div>
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_3 == 'yes3', 'one__bg' : this.prevention.prevention_3 !== 'yes3'}" style="width:3630%">36%</div>
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar upper">
          ...
          <div class="result two" :class="{'active cont' : this.prevention.prevention_4 == 'monthly'}" style="width:15%">
        ...
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'weekly', 'one__bg' : this.prevention.prevention_4 !== 'weekly'}" style="width:25%">25%</div>
          ...
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'yearly', 'three__bg' : this.prevention.prevention_4 !== 'yearly'}" style="width:10%">4%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'almostNever', 'four__bg' : this.prevention.prevention_4 !== 'almostNever'}" style="width:20%">8%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'never', 'five__bg' : this.prevention.prevention_4 !== 'never'}" style="width:30%">48%</div>
        </div>
        <div class="row">
          <div class="dot__content">
