  ...
  <div class="interview">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar upper">
          <div class="result one" :class="{'active cont' : this.prevention.prevention_2 == 'yes2'}" style="width:65%">
            <p :class="{'visible' : this.prevention.prevention_2 == 'yes2', 'not__visible' : this.prevention.prevention_2 !== 'yes2'}">Twój wynik</p>
          </div>
          <div class="result two" :class="{'active cont' : this.prevention.prevention_2 == 'no2'}" style="width:35%">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar upper">
          ...
          <div class="result two" :class="{'active cont' : this.prevention.prevention_3 == 'no3'}" style="width:36%">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'weekly', 'one__bg' : this.prevention.prevention_4 !== 'weekly'}" style="width:25%">19%</div>
          ...
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'never', 'five__bg' : this.prevention.prevention_4 !== 'never'}" style="width:30%">51%</div>
        </div>
        <div class="row">
          <div class="dot__content">
