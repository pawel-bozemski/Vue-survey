  ...
  <div class="interview">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar">
          <div class="result one" :class="{'active' : this.prevention.prevention_4 == 'weekly'}" style="width:22%">
            <p :class="{'visible' : this.prevention.prevention_4 == 'weekly', 'not__visible' : this.prevention.prevention_4 !== 'weekly'}">Twój wynik</p>
          </div>
          <div class="result two" :class="{'active' : this.prevention.prevention_4 == 'monthly'}" style="width:26%">
        ...
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'weekly', 'one__bg' : this.prevention.prevention_4 !== 'weekly'}" style="width:22%">22%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'monthly', 'two__bg' : this.prevention.prevention_4 !== 'monthly'}" style="width:26%">26%</div>
          ...
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'never', 'one__bg' : this.prevention.prevention_4 !== 'never'}" style="width:30%">30%</div>
        </div>
        <div class="row">
          <div class="dot__content">
