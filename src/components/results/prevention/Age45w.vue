  ...
  <div class="interview">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
          ...
          <div class="bar upper">
          <div class="result one" :class="{'active cont' : this.prevention.prevention_4 == 'weekly'}" style="width:30%">
            <p :class="{'visible' : this.prevention.prevention_4 == 'weekly', 'not__visible' : this.prevention.prevention_4 !== 'weekly'}">Twój wynik</p>
          </div>
          <div class="result two" :class="{'active' : this.prevention.prevention_4 == 'monthly'}" style="width:25%">
        ...
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'weekly', 'one__bg' : this.prevention.prevention_4 !== 'weekly'}" style="width:30%">31%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'monthly', 'two__bg' : this.prevention.prevention_4 !== 'monthly'}" style="width:25%">30%</div>
          ...
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'almostNever', 'four__bg' : this.prevention.prevention_4 !== 'almostNever'}" style="width:15%">14%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'never', 'five__bg' : this.prevention.prevention_4 !== 'never'}" style="width:20%">18%</div>
        </div>
        <div class="row">
          <div class="dot__content">
