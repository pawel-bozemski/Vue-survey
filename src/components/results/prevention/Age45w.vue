  ...
  <div class="interview">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar">
          <div class="result one" :class="{'active' : this.prevention.prevention_4 == 'weekly'}" style="width:31%">
          ...
          <div class="result two"  :class="{'active' : this.prevention.prevention_4 == 'almostNever'}" style="width:14%">
          ...
          <div class="result one" :class="{'active' : this.prevention.prevention_4 == 'never'}" style="width:18%">
            <p :class="{'visible' : this.prevention.prevention_4 == 'never', 'not__visible' : this.prevention.prevention_4 !== 'never'}">Twój wynik</p>
          </div>
        </div>
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'weekly', 'one__bg' : this.prevention.prevention_4 !== 'weekly'}" style="width:31%">31%</div>
          ...
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'almostNever', 'two__bg' : this.prevention.prevention_4 !== 'almostNever'}" style="width:14%">14%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'never', 'one__bg' : this.prevention.prevention_4 !== 'never'}" style="width:18%">18%</div>
        </div>
        <div class="row">
          <div class="dot__content">
