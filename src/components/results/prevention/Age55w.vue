  ...
  <div class="interview">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'weekly', 'one__bg' : this.prevention.prevention_4 !== 'weekly'}" style="width:20%">32%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'monthly', 'two__bg' : this.prevention.prevention_4 !== 'monthly'}" style="width:20%">31%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'yearly', 'three__bg' : this.prevention.prevention_4 !== 'yearly'}" style="width:20%">6%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'almostNever', 'four__bg' : this.prevention.prevention_4 !== 'almostNever'}" style="width:20%">14%</div>
