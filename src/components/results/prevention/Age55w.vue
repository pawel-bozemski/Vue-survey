    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar">
          ...
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'yearly', 'one__bg' : this.prevention.prevention_4 !== 'yearly'}" style="width:20%">6%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'almostNever', 'two__bg' : this.prevention.prevention_4 !== 'almostNever'}" style="width:20%">14%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'never', 'one__bg' : this.prevention.prevention_4 !== 'never'}" style="width:20%">17%</div>
        </div>
        <div class="row">
          <div class="dot__content">
