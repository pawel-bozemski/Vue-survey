  ...
  <div class="interview">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
          ...
          <div class="bar upper">
          <div class="result one" :class="{'active cont' : this.prevention.prevention_2 == 'yes2'}" style="width:25%">
            <p :class="{'visible' : this.prevention.prevention_2 == 'yes2', 'not__visible' : this.prevention.prevention_2 !== 'yes2'}">Twój wynik</p>
          </div>
          <div class="result two" :class="{'active' : this.prevention.prevention_2 == 'no2'}" style="width:25%">
            <p :class="{'visible' : this.prevention.prevention_2 == 'no2', 'not__visible' : this.prevention.prevention_2 !== 'no2'}">Twój wynik</p>
          </div>
        </div>
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_2 == 'yes2', 'one__bg' : this.prevention.prevention_2 !== 'yes2'}" style="width:25%">61%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_2 == 'no2', 'two__bg' : this.prevention.prevention_2 !== 'no2'}" style="width:25%">39%</div>
        </div>
        <div class="row">
          <div class="dot__content">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
          ...
          <div class="bar upper">
          <div class="result one" :class="{'active cont' : this.prevention.prevention_3 == 'yes3'}" style="width:25%">
            <p :class="{'visible' : this.prevention.prevention_3 == 'yes3', 'not__visible' : this.prevention.prevention_3 !== 'yes3'}">Twój wynik</p>
          </div>
          <div class="result two" :class="{'active' : this.prevention.prevention_3 == 'no3'}" style="width:25%">
            <p :class="{'visible' : this.prevention.prevention_3 == 'no3', 'not__visible' : this.prevention.prevention_3 !== 'no3'}">Twój wynik</p>
          </div>
        </div>
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_3 == 'yes3', 'one__bg' : this.prevention.prevention_3 !== 'yes3'}" style="width:25%">36%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_3 == 'no3', 'two__bg' : this.prevention.prevention_3 !== 'no3'}" style="width:25%">64%</div>
        </div>
        <div class="row">
          <div class="dot__content">
    ...
    <div class="jumbotron">
      ...
      <div class="questions">
        ...
        <div class="bar">
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'weekly', 'one__bg' : this.prevention.prevention_4 !== 'weekly'}" style="width:20%">29%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'monthly', 'two__bg' : this.prevention.prevention_4 !== 'monthly'}" style="width:20%">30%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'yearly', 'three__bg' : this.prevention.prevention_4 !== 'yearly'}" style="width:20%">7%</div>
          <div class="result" :class="{'active' : this.prevention.prevention_4 == 'almostNever', 'four__bg' : this.prevention.prevention_4 !== 'almostNever'}" style="width:20%">15%</div>
